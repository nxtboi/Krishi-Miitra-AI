...
export const AmazonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <title>Amazon</title>
        <path d="M15.5 13c-.2-1.5-1.1-2.4-2.5-2.4-1.5 0-2.4 1-2.5 2.4h5zm-1.8 4.2c2.6-1.4 5.9-1.4 8.5 0 .4.2.5.7.3 1.1-.2.4-.7.5-1.1.3-2.1-1.1-4.7-1.1-6.8.2-.4.2-.9.2-1.1-.2-.3-.4-.2-.9.2-1.4zM12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm3.3 13.7c-.5.4-1.3.7-2.3.7-1.7 0-3.3-.9-3.7-2.7h6.6c.1-2.3-1.4-4-3.5-4-2.1 0-3.8 1.6-3.8 4.1 0 2.5 1.7 4.1 4.2 4.1 1.1 0 2.1-.4 2.8-1 .4-.3.4-.9.1-1.3-.2-.2-.2-.2-.4.1z" fill="#232F3E"/>
        <path d="M18.7 17.2c-2.6-1.4-5.9-1.4-8.5 0-.4-.2-.5-.7-.3-1.1.2-.4.7-.5 1.1-.3 2.1 1.1 4.7 1.1 6.8-.2.4-.2.9-.2 1.1.2.3.4.2.9-.3 1.4z" fill="#FF9900"/>
    </svg>
);
...
export const FlipkartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path fill="#2874F0" d="M15 3.5h-4.5v11.5h1.5v-3.5h1.5c2 0 3.5-1.5 3.5-3.5s-1.5-4.5-3.5-4.5h1.5z"/>
        <path fill="#FFDA00" d="M14.5 12l-1.5-2.5h-1v6h1.5l1-3.5h.5l2.5 3.5h1.5l-3-4z"/>
        <path fill="#2874F0" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8z" opacity="0.1"/>
    </svg>
);
...
export const IndiaMartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" fill="#2E3192"/>
        <path d="M7.5 16h2V8h-2v8zm4.5 0h2v-5l-2 2v3zm4.5 0h2V8h-2l-2 2v6z" fill="#00A699"/>
        <path d="M12 8l-2 2v6h4v-6l-2-2z" fill="#FFF"/>
    </svg>
);
